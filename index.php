    ...
    <div class="main">
        ...
        <section>
            <div class="container" style="margin-top:55px;">
                ...
                <h5>Выводы о сравнении в PHP</h5>
                <p>
                    Жёсткое сравнение в PHP более безопастное сравнение, если надо сравнивать не только значение но и тип.<br>
                    При условии что у нас имеется число 0, то при гибком сравнении есть шанс, что при сравнении с NULL мы будем получать положительный результат, что не есть хорошо.<br>
                    Лично я сторонник более строгой типизации, скорее всего буду стараться использовать жесткое сравнение.
                </p>
